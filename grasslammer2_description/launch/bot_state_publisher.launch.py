...
def generate_launch_description():
    ...
    urdf_file = os.path.join(pkg_path, 'urdf', 'model_long.urdf') # 'model_short.urdf' if you want to use the short legs configuration, remember to change also params in the config/controller.yaml
