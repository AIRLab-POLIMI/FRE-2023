...
class InRowNavigation(Node):
    ...
    def in_row_navigation_forward(self, points_nord_east, points_nord_west, points_south_east, points_south_west):
        ...
        if is_nord_east_empty & is_nord_west_empty & is_south_east_empty & is_south_west_empty:
            if (self.is_goal_published==True) and (self.line_entered ==True):
                ...
                if(self.end_of_line_pose_message!= ''):
    ...
    def calculate_end_of_line_pose_perpendicular_crop_forward(self):
        ...
        transform = self._tf_buffer.lookup_transform('odom', 'velodyne', end_of_line_pose.header.stamp, Duration(seconds=1, nanoseconds=0))
